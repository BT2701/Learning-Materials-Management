...
public class DeviceView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnXacNhan.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/View/images/xacnhan_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)));
        ...
        btnThem.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/View/images/add_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)));
        ...
        btnSua.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/View/images/edit_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)));
        btnSua.setText("Sửa");
        ...
        btnXoa.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/View/images/delete_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)));
        btnXoa.setText("Xóa");
        ...
        btnXoaNhieu.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/View/images/delete_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)));
        ...
        btnNhapExcel.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/View/images/importExcel_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)));
        ...
        btnRefresh.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/View/images/refresh_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)));
